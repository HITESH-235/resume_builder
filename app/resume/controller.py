...
# --------------------------------------------------------------------------------------------------------
    # Basic Resume functions (create/get/get-all/delete/duplicate/update)
    ...
    def get_resume(resume_id):
        ...
        if status != 200: return jsonify(response), status # in that case response has error message
            ...
            "experiences": [
                {
                    ...
                    "start_date": assoc.experience.start_date.strftime("%Y-%m-%d") if assoc.experience.start_date else "",
...
# --------------------------------------------------------------------------------------------------------
    # Skills in Resume all functions:
...
# --------------------------------------------------------------------------------------------------------
    # Experience in Resume all functions:
...
# --------------------------------------------------------------------------------------------------------
    # Education in Resume all functions:
...
# --------------------------------------------------------------------------------------------------------
    # Projects in Resume all functions:
    ...
    def reorder_project(resume_id):
        ...
        response, status = ResumeService.reorder_projects(user_id, resume_id, data["ordered_ids"])
        return jsonify(response), status


# --------------------------------------------------------------------------------------------------------
    # Certifications in Resume all functions:
    ...
    def reorder_certification(resume_id):
        ...
        response, status = ResumeService.reorder_certifications(user_id, resume_id, data["ordered_ids"])
        return jsonify(response), status


# --------------------------------------------------------------------------------------------------------
    # Courses in Resume all functions:
    ...
    def reorder_course(resume_id):
        ...
        response, status = ResumeService.reorder_courses(user_id, resume_id, data["ordered_ids"])
        return jsonify(response), status


# --------------------------------------------------------------------------------------------------------
    # Achievements in Resume all functions:
